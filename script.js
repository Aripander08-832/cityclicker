...
var City = function(data) {
  ...
  this.residentTax = new Update(this, data.residentTax, 100, 1.8, function() {
  ...
  this.commerceTax = new Update(this, data.commerceTax, 100, 1.78, function() {
  ...
  this.industryTax = new Update(this, data.industryTax, 100, 1.75, function() {
